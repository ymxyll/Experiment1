...
int main(void)
{
  ...
  while (1)
  {
    ...
    if (HAL_GPIO_ReadPin(GPIOC, GPIO_PIN_3) == GPIO_PIN_RESET)  /* sw4 */
...
static void MX_GPIO_Init(void)
{
  ...
  GPIO_Initure.Pin = GPIO_PIN_0 | GPIO_PIN_1 | GPIO_PIN_2 | GPIO_PIN_3 | GPIO_PIN_7 | GPIO_PIN_6;  /* led1/2/7*/
  ...
  GPIO_Initure.Pin = GPIO_PIN_0 | GPIO_PIN_1 | GPIO_PIN_2 | GPIO_PIN_3;  /* sw1 & 2*/
